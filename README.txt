...
part. Please watch 'Arduino with Bluetooth.MP4' to check if the application worked as
expected.
...
Please watch the 'Info Relay and MQTT Client.mov' to see how the InfoRelay and MQTT Client application
is runned and follow it step-by-step.